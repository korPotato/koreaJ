...
//		}
//		if(count > 4) {
//			parse1 = result.substring(result_len-6, result_len);
//			parse2 = result.substring(result_len-6, result_len-3);
//			parse3 = result.substring(result_len-9, result_len-3);
//			parse4 = result.substring(0, result_len-9);
