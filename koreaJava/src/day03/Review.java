...
public class Review {
	public static void main(String[] args) {
		...
		// 프로그래밍 언어의 발전은 '수정'에 초점이 맞춰어있음
		// 변수 : 저장공간, 자주 변경될 것 같은 혹은 자주 사용될 것 같은 데이터를 저장해놓는 공간(재활용, 값 수정)
		// 자료형 변수명;ㅣ
		
		String 변수1; 		// 문자열(글자) 저장공간
		int 변수2; 			// 정수(숫자) 
		double 변수3; 		// 실수(소수점있는숫자)
		
		// 변수 대입 (값넣기) : = 을 사용해서 값을 넣음( 이미 생성된 변수에 대해서는 자료형을 적으면 안됨)
		변수1 = "Java";
		변수2 = 123;
		변수3 = 3.14;
		
		// 변수 초기화(선언과 동시에 대입을 한번에)
		String 변수4 = "선언과 동시에 대입";			// 초기화라고 한다.
		
		// 변수 사용 : 변수명을 적어줌, 변수 안에 들어있는 값이 사용됨
		System.out.println(변수4);
		
		// 대입시 유의사항
		변수4 = 변수1; 		// 오른쪽에 있는 것은 값사용, 왼쪽에 있는 것은 공간 개념
		System.out.println(변수4);
